...
Pod::Spec.new do |spec|
  ...
  #  Cocoaspec.dependencys will detect a license file if there is a named LICENSE*
  ...
  #  of the authors are extracted from the SCM log. E.g. $ git log. Cocoaspec.dependencys also
  ...
  # ――― Platform Specifics ――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
  #  If this spec.dependency runs only on iOS or OS X, then specify the platform and
  ...
  # ――― Source Code ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
  #  Cocoaspec.dependencys is smart about how it includes source code. For source files
  ...
  # ――― Resources ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  #
  #  A list of resources included with the spec.dependency. These are copied into the
